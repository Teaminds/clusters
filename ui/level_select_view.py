...
Цель игры: набрать заданное количество очков за отведённое время.

Управление: мышью.

Подсказка: чем сильнее фигуры в группе похожи друг на друга и чем больше группа — тем больше очков приносит каждая.
